    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('service_manager', 'Service Manager'), ('customer', 'Customer')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center_manager', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Servicing',
            fields=[
                ...
                ('provided_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.servicecenter')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('discount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('sold_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.servicecenter')),
            ],
        ),
    ]
